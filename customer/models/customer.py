...
class Customer(db.Model):
    ...
    CustomerBalance = db.Column(db.Float, nullable=True)
    EffectiveStartDate = db.Column(db.DateTime, nullable=False, default=datetime)
    ...
    StatusDateTime = db.Column(db.DateTime)
